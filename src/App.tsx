    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 text-zinc-300 font-sans relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <button
          onClick={handleLogin}
          disabled={loading}
          className="w-full bg-white hover:bg-zinc-100 text-zinc-900 font-black py-4 px-6 rounded-xl text-sm transition-all flex items-center justify-center gap-3 shadow-lg shadow-red-600/10 active:scale-95 cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
        >
        ...
        {loginError && (
          <div className="mt-4 p-3 bg-red-900/40 border border-red-600/40 rounded-lg text-sm text-red-300">
            <p>{loginError}</p>
            <p className="mt-2 text-xs text-zinc-400">
              Consejo: permite las ventanas emergentes en la barra de direcciones de tu navegador (icono de popup bloqueado) e inténtalo de nuevo.
            </p>
          </div>
        )}
      </div>
